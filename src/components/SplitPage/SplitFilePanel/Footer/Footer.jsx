...
const Footer = () => {
  ...
  const [showSplitInfoHelp, setShowSplitInfoHelp] = useState(false);
    ...
    <div className="flex h-20 flex-col bg-neutral-300 py-2 pr-2 pl-14">
      ...
      <div className="flex flex-1 items-center gap-2">
        <div className="relative flex-1 bg-emerald-200">
          <span
            className="absolute top-1/2 -left-6 flex h-5 w-5 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full border border-neutral-400 bg-neutral-100 text-neutral-600 select-none hover:scale-110"
            onClick={() => setShowSplitInfoHelp(true)}
          >
            i
          </span>
          <input
      ...
      {showSplitInfoHelp && (
        <Modal closeCallback={() => setShowSplitInfoHelp(false)}>
          <div className="flex h-64 w-sm flex-col overflow-y-auto xl:w-md 2xl:w-xl">
            <div className="flex w-full items-center justify-between">
              ...
              <button onClick={() => setShowSplitInfoHelp(false)}>
                <CrossIcon className="h-6 w-6 cursor-pointer" />
              </button>
            </div>
            <div className="mt-4">
              <p className="mt-2">
                Utiliza comas ( , ) para separar páginas individuales y/o
                rangos.
              </p>
              ...
              <ul className="list-inside list-disc font-light">
                ...
                <li>
                  1, 4-6, 9 selecciona la página 1, las páginas 4 a 6 y la
                  página 9.
                </li>
              </ul>
            </div>
